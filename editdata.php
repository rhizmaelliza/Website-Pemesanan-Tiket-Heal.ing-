<?php
    ...
    //Mengecek apakah id di query string
    if (!isset($_GET['id'])) {
        header('Location: datapengunjung.php');
    }

    //Jika ada, ambil id dari query string 
    $id = $_GET['id'];    
...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            ...
            <!-- Navigation Bar yang menyesuaikan ukuran layar -->
...
<?php
//Mengecek apakah setiap kolom sudah terisi atau belum
if (isset($_POST['tanggal']) && isset($_POST['nama']) && isset($_POST['email']) && isset($_POST['askot']) && isset($_POST['tujuan']) && isset($_POST['nohp'])) {
    if (isset($_POST['edit'])) {
        ...
        if ($query) {
            //Jika berhasil alihkan ke halaman laporanpengunjung.php
