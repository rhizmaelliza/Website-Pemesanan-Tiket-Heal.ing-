...
<body>
    ...
    <div class="row">
        ...
        <!-- Membuat Kolom Utama/Judul Tiap Kolom -->
        <thead>
            <tr>
                <th>ID</th>
        ...
        <!-- Membuat Isian -->
        <tbody>
        	<!-- Mengambil nilai dari tb_pesanan untuk ditampilkan -->
            <?php
    ...
    <!-- Membuat Tombol untuk Menambah Data Pengunjung dan Mencetak sebagai Excel -->
    <div class="row">    	
